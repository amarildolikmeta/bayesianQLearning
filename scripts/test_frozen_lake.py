...
if __name__ == "__main__":
    ...
    algorithms={
                        ...
                        "PVF2_SU":{"alg":"PVF2", "update":"SORTED_UPDATE", "selection":"MYOPIC_VPI"}, 
                        "PVF2_QU":{"alg":"PVF2", "update":"QUANTILE_UPDATE", "selection":"MYOPIC_VPI"}, 
                        "PVF_CB":{"alg":"PVF2", "update":"COUNT_BASED","selection":"MYOPIC_VPI"} , 
    }
...
'''
    ...
    df.to_csv("test_frozen_lake_pvf.csv", sep=',')
